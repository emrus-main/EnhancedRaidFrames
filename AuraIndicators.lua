...
function EnhancedRaidFrames:CreateIndicators(frame)
	...
	for i = 1, 9 do
		for k = 1, 6 do
			...
			f[frameName][i*4+k] = CreateFrame("Button", nil, frame)
			...
			button.text = button:CreateFontString(nil, "OVERLAY", "NumberFontNormalSmall") --if we don't show the animation, text should be on the parent frame
			button.text:SetPoint("CENTER", button, "CENTER", 0, 0)

			if i == 1 then
				button:SetPoint("TOPLEFT", frame, "TOPLEFT", PAD + (k-1) * EnhancedRaidFrames.db.profile["iconSize"..i], -PAD)
			elseif i == 2 then
				button:SetPoint("TOP", frame, "TOP", 0, -PAD)
			elseif i == 3 then
				button:SetPoint("TOPRIGHT", frame, "TOPRIGHT", -PAD - (k-1) * EnhancedRaidFrames.db.profile["iconSize"..i], -PAD)
			elseif i == 4 then
				button:SetPoint("LEFT", frame, "LEFT", PAD + (k-1) * EnhancedRaidFrames.db.profile["iconSize"..i], 0)
			elseif i == 5 then
				button:SetPoint("CENTER", frame, "CENTER", 0, 0)
			elseif i == 6 then
				button:SetPoint("RIGHT", frame, "RIGHT", -PAD - (k-1) * EnhancedRaidFrames.db.profile["iconSize"..i], 0)
			elseif i == 7 then
				button:SetPoint("BOTTOMLEFT", frame, "BOTTOMLEFT", PAD + (k-1) * EnhancedRaidFrames.db.profile["iconSize"..i], PAD)
			elseif i == 8 then
				button:SetPoint("BOTTOM", frame, "BOTTOM", 0, PAD)
			elseif i == 9 then
				button:SetPoint("BOTTOMRIGHT", frame, "BOTTOMRIGHT", -PAD - (k-1) * EnhancedRaidFrames.db.profile["iconSize"..i], PAD)
			end
			...
			EnhancedRaidFrames:SecureHookScript(button, "OnEnter", function() EnhancedRaidFrames:Tooltip_OnEnter(button) end)
			EnhancedRaidFrames:SecureHookScript(button, "OnLeave", function() EnhancedRaidFrames:Tooltip_OnLeave(button) end)
		end
	end
...
function EnhancedRaidFrames:SetIndicatorAppearance(frame)
	...
	for i = 1, 9 do
		for k = 1, 6 do
			local button = f[frameName][i*4+k]
			button:SetWidth(EnhancedRaidFrames.db.profile["iconSize"..i])
			button:SetHeight(EnhancedRaidFrames.db.profile["iconSize"..i])
